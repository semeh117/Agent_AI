...
Usage:
    python scripts/inspect_job_parsing.py
    python scripts/inspect_job_parsing.py --query "machine learning engineer"
    python scripts/inspect_job_parsing.py --query "ml engineer" --location "Tunisia" --count 2
    python scripts/inspect_job_parsing.py --no-cache
"""
...
from next_chapter.parsing.agent2_job_parser import _find_job_section_headings, _job_regions  # noqa: E402
from next_chapter.parsing.agent2_parser import extract_job_requirements_agent2  # noqa: E402
