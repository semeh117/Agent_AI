...
from next_chapter.config import get_cover_letter_llm
...
def generate_cover_letter(cv_info, top_result: dict, llm=None) -> str:
    ...
    Args:
        ...
        llm: optional pre-built LLM instance; defaults to src/next_chapter/config.py's
            configured model.
    ...
    """
    if llm is None:
        llm = get_cover_letter_llm(temperature=0.3)
