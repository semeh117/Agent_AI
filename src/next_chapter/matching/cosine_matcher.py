...
``calculate_compatibility_cosine`` mirrors ``next_chapter.matching.matcher``: it receives one
...
from next_chapter.matching.esco_normalizer import NormalizedSkill, get_esco_normalizer
from next_chapter.matching.matcher import _education_match, _experience_match
...
def _skills_match_cosine(
    ...
    if remaining and candidates:
        if embeddings is None:
            from next_chapter.config import get_embeddings
