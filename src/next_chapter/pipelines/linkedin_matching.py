...
from next_chapter.matching.cosine_matcher import rank_jobs_by_cosine
...
def match_linkedin_jobs(
    ...
    *,
    ...
    search_limit = search_pool_size if search_pool_size is not None else max_jobs
    ...
    if parser_fn is None:
        from next_chapter.parsing.agent2_parser import extract_job_requirements_agent2
