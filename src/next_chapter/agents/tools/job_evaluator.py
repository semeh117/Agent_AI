...
from next_chapter.parsing.job_parser import extract_job_requirements
from next_chapter.matching.matcher import calculate_compatibility
from next_chapter.storage.seen_jobs_memory import record_seen
from next_chapter.search.himalayas import set_candidate_email
