...
already evaluated as the top match. Wraps src/next_chapter/services/cover_letter.py's
...
from next_chapter.services.cover_letter import generate_cover_letter
import next_chapter.agents.tools.job_evaluator as job_evaluator  # import the MODULE, not the
