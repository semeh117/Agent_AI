...
candidate via a Telegram bot message. Wraps src/next_chapter/delivery/telegram.py
...
import next_chapter.agents.tools.job_evaluator as job_evaluator  # module import, see
# cover_letter_tool.py for why this must NOT be `from ... import _current_cv_info`
import next_chapter.agents.tools.cover_letter as cover_letter   # same reasoning: need the
