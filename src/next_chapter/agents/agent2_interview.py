...
``src/next_chapter/agents/agent2.py``. Interview packs cost thousands of LLM tokens, so they are
...
functions in ``src/next_chapter/services/interview_preparation.py`` that Agent 3's tool also
uses.
...
from next_chapter.services.interview_preparation import (
