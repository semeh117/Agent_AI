"""Agent 1's Himalayas search/evaluate tools and original ReAct executor."""
from langchain.agents import  AgentExecutor , create_react_agent
from langchain_core.prompts import PromptTemplate

from next_chapter.config import get_llm
...
from next_chapter.agents.react_output_parser import TolerantReActSingleInputOutputParser
