...
import json
from next_chapter.search.himalayas import search_real_jobs, set_candidate_email
from next_chapter.agents.tools.job_search_tool import search_jobs_for_agent
from next_chapter.storage.seen_jobs_memory import record_seen, _get_connection
