...
Run:
    python examples/compare_document_extractors.py --cv cv/Semah_Mechi_.pdf
"""
...
from next_chapter.parsing.agent2_document_extractor import (  # noqa: E402
    detect_cv_sections,
    extract_cv_document_agent2,
)
from next_chapter.parsing.cv_parser import extract_text_from_pdf  # noqa: E402
import next_chapter.parsing.agent2_document_extractor as document_extractor  # noqa: E402
import next_chapter.storage.extraction_cache as extraction_cache  # noqa: E402
...
def main() -> int:
    ...
    if args.test_cache:
        from tests.test_agent2_document_extractor import test_agent2_document_extraction_cache
