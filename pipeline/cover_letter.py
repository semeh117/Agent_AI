...
def generate_cover_letter(cv_info, top_result: dict, llm=None) -> str:
    ...
    """
    if llm is None:
        llm = get_llm(temperature=0.3)  # slightly higher than 0.0 — this is
        # generative prose, not structured extraction, so a little
        # variation in phrasing is fine and even desirable here.
