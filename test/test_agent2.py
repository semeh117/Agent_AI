"""Interactive end-to-end test for the new LinkedIn Agent 2."""
...
from agent.agent2 import run_agent2_full_auto_from_pdf
...
print("\n=== FULL LINKEDIN AGENT 2 WORKFLOW ===")
result = run_agent2_full_auto_from_pdf(
    str(selected_path),
    results_count=3,
    location=location,
)
