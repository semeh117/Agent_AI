...
CV_FIXTURE = PROJECT_ROOT / "tests" / "fixtures" / "parsers" / "cv_parser_fixture.json"
JOB_FIXTURE = PROJECT_ROOT / "tests" / "fixtures" / "parsers" / "linkedin_job_parser_fixture.json"
...
def test_replayed_cv_reports_programme_level_titles_and_headline():
    ...
    from next_chapter.pipelines.linkedin_matching import build_linkedin_query
...
def test_job_region_fallback_never_scores_duties():
    from next_chapter.parsing.agent2_job_parser import _job_regions
