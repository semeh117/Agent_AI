...
Usage:
    python -m evaluation.benchmark_parser_models
    python -m evaluation.benchmark_parser_models --models z-ai/glm-5.2:free
    python -m evaluation.benchmark_parser_models --self-test
...
DEFAULT_CV_FIXTURE = PROJECT_ROOT / "tests" / "fixtures" / "parsers" / "cv_parser_fixture.json"
DEFAULT_JOB_FIXTURE = PROJECT_ROOT / "tests" / "fixtures" / "parsers" / "linkedin_job_parser_fixture.json"
DEFAULT_OUTPUT = PROJECT_ROOT / "output" / "benchmarks" / "parser_model_benchmark.json"
...
def _run_model(
    ...
    from next_chapter.config import _build_llm
...
def main() -> int:
    ...
    from next_chapter import config as _project_config  # noqa: F401
